...
<body>
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">About Prime Assets Group</li>
                    </ol>
                </div>
            </div>
        </div>
    ...
    <div class="content-section">
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <p class="text-decor-1">Prime Assets Group </p>
                    <p class="text-decor-2">About Prime Assets Group
                    </p>
                    <p>Founded in 2017, Prime Assets Group is an investment vehicle that have experts in
                        date analysis that specialize in conservative and arbitrage trading opportunities. Prime Assets Group
                    ...
                    <p>
                        Business failures are an unfortunate but fairly a common part of business. Prime Assets Group as an
                    ...
                    <p>
                        ...
                        learnings to come back stronger. With the financial investment behind the Prime Assets Group project,
                ...
                <div class="col-md-9 col-lg-8">
                    <div id="testimonials" class="testimonials-owl owl-theme owl-carousel">
                        <div class="testimonials-item">
                            ...
                            <div class="content">
                                <p>" I just can't get enough of Prime Assets Group. I want to get a T-Shirt with Prime Assets Group on it so I can
                                    show it off to everyone. Prime Assets Group has completely surpassed our expectations. "</p>
                            </div>
                        </div>
                        <div class="testimonials-item">
                            <header>
                            ...
                            <div class="content">
                                <p>" Very easy to use. I have gotten at least 50 times the value from Prime Assets Group. Keep up the
                                    excellent work. "</p>
                            </div>
                        </div>
                        <div class="testimonials-item">
                            ...
                            <div class="content">
                                <p>" Prime Assets Group is both attractive and highly adaptable. It's incredible. Prime Assets Group is the next
                                    killer app. "</p>
                            </div>
                        </div>
                    </div>
