        ...
        <div class="row align-items-center justify-content-center">
            <div class="col-xl-6 col-lg-7 col-sm-12 col-12 fxt-bg-color">
                <div class="fxt-content">
                    ...
                    <div class="fxt-form">
                        <form method="POST" action="https://www.primeassetsgroup.com/register">
                            <input type="hidden" name="_token" value="Ygsm6ACbeVkeFOjvfC2acW8nj3OJVoE2wfcM2ulY">                            <input type="hidden" name="referrer" value="" />
...
<option value="Zimbabwe">Zimbabwe</option>                                    </select>
                                ...
                                <div class="fxt-transformY-50 fxt-transition-delay-3">
                                    <div class="fxt-checkbox-area">
                                        <div class="checkbox">
                                            ...
                                            <label for="checkbox1">I accept <a class="text-primary" href="terms.html">Terms
                    ...
                    <div class="fxt-footer">
                        <div class="fxt-transformY-50 fxt-transition-delay-9">
                            <p>Already have an account?<a href="{{ url('login')}}" class="switcher-text2 inline-text">Log in</a></p>
                        </div>
                    </div>
                </div>
            </div>
