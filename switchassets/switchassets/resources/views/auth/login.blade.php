         ...
         <div class="row align-items-center justify-content-center">
             <div class="col-xl-6 col-lg-7 col-sm-12 col-12 fxt-bg-color">
                 <div class="fxt-content">
                     ...
                     <div class="fxt-form">
                         <form method="POST" action="https://www.primeassetsgroup.com/login">
                             <input type="hidden" name="_token" value="Ygsm6ACbeVkeFOjvfC2acW8nj3OJVoE2wfcM2ulY">                             <div class="form-group">
