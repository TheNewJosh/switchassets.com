                        ...
                        <div class="row site-footer-content">
                            <div class="col-md-3 site-footer-logo">
                                <div>
                                    ...
                                    <!-- Logo end -->
                                    <p>Switch Assets Group offers an exceptional solution on the efficient management of
                                        our
                                ...
                                <p>Copyright @ 2021 U.S.
                                    <a href="#">Switch Assets Group</a>, Inc.
                                </p>
                            </div>
                            <div class="col-md-3 col-md-push-1">
                                <div class="widget widget-contacts">
                                    ...
                                    <div class="widget-content">
                                        ...
                                        <p>
                                            <a href="{{ url('stcok')}}">Stock Investment</a>
                                        </p>
                                        <p>
                            ...
                            <div class="col-md-3 col-md-push-1">
                                <div class="widget widget-contacts">
                                    ...
                                    <div class="widget-content">
                                        <p class="title text-heading">Switch Assets Group.</p>
