...
<body>
    ...
    <div class="content-section">
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <p class="text-decor-1">welcome to Switch Assets Group</p>
                ...
                <div class="col-md-6">
                    ...
                    <p>Our trading software is designed by our in-house specialists at Switch Assets Group. Our algorithm and
            ...
            <div class="row">
                ...
                <div class="col-md-4 icon-box v1">
                    ...
                    <div>
                        ...
                        <p>Switch Assets Group is an investment firm with worldwide reach. We manage assets for our clients
                            in
                    ...
                    <div id="index-1-services" class="owl-theme owl-carousel">
                        ...
                        <div class="service-simple"> <img src="images/big-images/real-estate.jpg" height="220" alt="img">
                            <div class="service-simple-inner">
                                ...
                                <p>The real estate funds and accounts managed by Switch Assets Group invest in a broad
                                    spectrum of
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <p>Since 2018 Switch Assets Group has strived to bring professional services to the world of digital
                        assets.
                        Leveraging the best of the team’s years of experience in FinTech along with the power of blockchain
                        technology, Switch Assets Group is empowering thousands of people to harness the value behind their
                        crypto
            ...
            <div class="row index-1-recent-cases-content">
                <div class="col-md-8">
                    <div class="content-section-header left safety">
                        ...
                        <p class="description">Switch Assets Group ensure the highest level of security for our clients
                            funds
