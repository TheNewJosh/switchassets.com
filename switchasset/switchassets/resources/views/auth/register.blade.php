                ...
                <div class="fxt-content">
                    ...
                    <div class="fxt-form">
                        <form method="POST" action="{{ route('register') }}">                          
                            @csrf
                            <input type="hidden" name="referrer" <?php if(isset($_GET['id'])){ ?> value="<?= $_GET['id'] ?>" <?php }else{ ?> value="{{ old('referrer') }}" <?php } ?> >
                            ...
                            <div class="form-group">
                                    <div class="fxt-transformY-50 fxt-transition-delay-1">
                                        <input type="number" class="form-control" name="referrer_id"
                                            placeholder="Referrer ID" value="{{ old('referrer_id')}}" />
                                    </div>
                                    @error('referrer_id')
                                        <small class="form-text text-danger">{{$message}}</small>
                                    @enderror
                                ...
                                <div class="fxt-transformY-50 fxt-transition-delay-3">
                                    <div class="fxt-checkbox-area">
                                        <div class="checkbox">
                                            ...
                                            <label for="checkbox1">I accept <a class="text-primary" href="{{ url('terms')}}">Terms
